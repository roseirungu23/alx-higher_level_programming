...
class Base:
    ...
    Attributes:
        __nb_objects (int): The number of instantiated Base."""
    ...
    def from_json_string(json_string):
        """Returns JSON string deserialization.
        Args:
    ...
    def save_to_file_csv(cls, list_objs):
        ...
        with open(filename, "w", newline="") as csvfile:
            if list_objs is None or list_objs == []:
                ...
                if cls.__name__ == "Rectangle":
                    localnames = ["id", "width", "height", "x", "y"]
                else:
                    localnames = ["id", "size", "x", "y"]
                writer = csv.DictWriter(csvfile, localnames=localnames)
        ...
        try:
            with open(filename, "r", newline="") as csvfile:
                if cls.__name__ == "Rectangle":
                    ...
                    localnames = ["id", "size", "x", "y"]
                list_dicts = csv.DictReader(csvfile, localnames=localnames)
